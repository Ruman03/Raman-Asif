          ...
          <div className="flex flex-col xl:flex-row gap-[30px]">
            ...
            <div className="xl:w-[54%] order-2 xl:order-none">
              <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl ">
                ...
                <p className="text-white/60">Ready to bring your web project to life? I'm here to help transform your ideas into reality with clean code and beautiful design.</p>
                {/* input */}
